...
function __fish_chezmoi_no_subcommand --description 'Test if chezmoi has yet to be given the subcommand'
	for i in (commandline -opc)
		if contains -- $i add apply archive cat cd chattr completion data diff docs doctor dump edit edit-config forget import init merge remove secret source source-path unmanaged update verify
			return 1
		end
	end
	return 0
